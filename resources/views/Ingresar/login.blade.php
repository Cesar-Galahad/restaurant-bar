...
<section class="bg-gray-50 dark:bg-gray-900">
  <div class="flex flex-col items-center px-6 py-12 mx-auto min-h-screen justify-center">
      ...
      <div class="text-center mb-8">
            <h1 class="text-4xl font-extrabold text-gray-900 dark:text-white">
                Bienvenido a La Lonja
            </h1>
            <p class="mt-3 text-lg text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                Sabores del mar, mixología de autor y el mejor ambiente.
            </p>
      </div>
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form method="POST" action="{{ route('empleado.login') }}" class="space-y-4 md:space-y-6">
              @csrf
                  <div>
